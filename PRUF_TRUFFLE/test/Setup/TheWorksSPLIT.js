...
contract('SPLIT', accounts => {
    ...
    it("Should retrieve balanceOf(52000) Pruf tokens @account2", async () => {
        var Balance = [];
    ...
    it('Should fail splitMyPruf for account1', async () => {
        return SPLIT.splitMyPruf(
            { from: account1 })
    })
    ...
    it('Should fail splitMyPruf for account2', async () => {
        return SPLIT.splitMyPruf(
            { from: account2 })
    })
