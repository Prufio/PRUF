        ...
        contract('TheWorksPIP', accounts => {
            ...
            it("Should Mint 2 cust and 2 non-cust AC tokens in AC_ROOT 1", async () => {
                ...
                return AC_MGR.createAssetClass("10", 'CUSTODIAL_AC10', '1', '1', '0', "0", rgt000, account1, { from: account1 })
                    ...
                    .then(() => {
                        ...
                        return AC_MGR.createAssetClass("13", 'CUSTODIAL_AC13', '1', '1', '0', "0", rgt000, account1, { from: account1 })
                    })
                    ...
                    .then(() => {
                        ...
                        return AC_MGR.createAssetClass("17", 'CUSTODIAL_AC17', '1', '2', '0', "0", rgt000, account1, { from: account1 })
                    })
                    ...
                    .then(() => {
                        ...
                        return AC_MGR.createAssetClass("19", 'CUSTODIAL_AC19', '1', '2', '0', "0", rgt000, account1, { from: account1 })
                    })
            })
            ...
            it('Should add users to AC 10-14 in AC_Manager', async () => {
                ...
                return AC_MGR.addUser('10', account2Hash, '1', { from: account1 })
                    ...
                    .then(() => {
                        console.log("Account10 => AC15 (PIPMINTER)")
                        return AC_MGR.addUser('13', account4Hash, '1', { from: account1 })
                    })
