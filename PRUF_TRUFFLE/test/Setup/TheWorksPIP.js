...
*---------------------------------------------------------------------------*/
        ...
        contract('TheWorksPIP', accounts => {
            ...
            it("Should Mint 2 cust and 2 non-cust AC tokens in AC_ROOT 1", async () => {
                ...
                return NODE_MGR.createAssetClass("10", 'CUSTODIAL_AC10', '1', '1', '0', "0", rgt000, account1, { from: account1 })
                    ...
                    .then(() => {
                        ...
                        return NODE_MGR.createAssetClass("13", 'CUSTODIAL_AC13', '1', '1', '0', "0", rgt000, account1, { from: account1 })
                    })
                    ...
                    .then(() => {
                        ...
                        return NODE_MGR.createAssetClass("17", 'CUSTODIAL_AC17', '1', '2', '0', "0", rgt000, account1, { from: account1 })
                    })
        
                    .then(() => {
                        console.log("Minting AC 18 -NC")
                        return NODE_MGR.createAssetClass("18", 'CUSTODIAL_AC18', '1', '2', '0', "0", rgt000, account1, { from: account1 })
                    })
        
                    .then(() => {
                        console.log("Minting AC 19 -NC")
                        return NODE_MGR.createAssetClass("19", 'CUSTODIAL_AC19', '1', '2', '0', "0", rgt000, account1, { from: account1 })
                    })
            })
            ...
            it('Should authorize NP in all relevant asset classes', async () => {
                ...
                return STOR.enableContractForAC('NP', '10', '1', { from: account1 })
                    ...
                    .then(() => {
                        return STOR.enableContractForAC('NP', '13', '1', { from: account1 })
                    })
            })
            ...
            it('Should authorize ECR in all relevant asset classes', async () => {
                ...
                return STOR.enableContractForAC('ECR', '10', '3', { from: account1 })
                    ...
                    .then(() => {
                        return STOR.enableContractForAC('ECR', '13', '3', { from: account1 })
                    })
            })
            ...
            it('Should add users to AC 10-14 in AC_Manager', async () => {
                ...
                return NODE_MGR.addUser('10', account2Hash, '1', { from: account1 })
                    ...
                    .then(() => {
                        console.log("Account10 => AC15 (PIPMINTER)")
                        return NODE_MGR.addUser('13', account4Hash, '1', { from: account1 })
                    })
    ...
    it('Should set SharesAddress', async () => {
        ...
        console.log("//**************************************BEGIN THE WORKS PIP**********************************************/")
