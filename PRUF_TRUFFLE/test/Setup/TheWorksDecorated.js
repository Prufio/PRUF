    ...
    it("Should Mint 2 cust and 2 non-cust Node tokens in AC_ROOT 1", async () => {
        ...
        return NODE_MGR.createNode("10", 'CUSTODIAL_AC10', '1', '1', '0', "0", rgt000, account1, { from: account1 })
            ...
            .then(() => {
                ...
                return NODE_MGR.createNode("16", 'CUSTODIAL_AC16', '1', '2', '1', "0", rgt000, account10, { from: account1 })
            })

            .then(() => {
                console.log("Minting Node 17 -NC")
                return NODE_MGR.createNode("17", 'CUSTODIAL_AC17', '1', '2', '3', "0", rgt000, account1, { from: account1 })
            })

            .then(() => {
                console.log("Minting Node 18 -NC")
                return NODE_MGR.createNode("18", 'CUSTODIAL_AC18', '1', '5', '4', "0", rgt000, account1, { from: account1 })
            })

            .then(() => {
                console.log("Minting Node 19 -NC")
                return NODE_MGR.createNode("19", 'CUSTODIAL_AC19', '1', '2', '5', "0", rgt000, account1, { from: account1 })
            })
    })
