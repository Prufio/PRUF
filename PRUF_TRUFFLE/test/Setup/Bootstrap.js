...
*---------------------------------------------------------------------------*/
        ...
        contract('BOOTSTRAP', accounts => {
            ...
            it("Should Mint 2 cust and 2 non-cust Node tokens in AC_ROOT 1", () => {
                ...
                return UTIL_TKN.mint(account1, "8000000000000000000000000", { from: account1 })
                    ...
                    .then(() => {
                        ...
                        return NODE_BLDR.purchaseNode("Custodial_AC1", "1", "1", rgt000, { from: account1 })
                    })
        
                    .then(() => {
                        console.log("Minting Node 1000002 -NC")
                        return NODE_BLDR.purchaseNode("Non_Custodial_AC2", "1", "2", rgt000, { from: account1 })
                    })
        
                    .then(() => {
                        console.log("Minting Node 1000003 -NC")
                        return NODE_BLDR.purchaseNode("Non_Custodial_AC3", "1", "2", rgt000, { from: account1 })
                    })
        
                    .then(() => {
                        console.log("Minting Node 1000004 -NC")
                        return NODE_BLDR.purchaseNode("Non_Custodial_AC4", "1", "2", rgt000, { from: account10 })
                    })
            })
            ...
            it("Should Mint 2 non-cust Node tokens in AC_ROOT 2", () => {
                ...
                return NODE_BLDR.purchaseNode("Non-Custodial_AC5", "2", "2", rgt000, { from: account1 })
        
                    .then(() => {
                        console.log("Minting Node 1000006 -NC")
                        return NODE_BLDR.purchaseNode("Non_Custodial_AC6", "2", "2", rgt000, { from: account10 })
                    })
            })
