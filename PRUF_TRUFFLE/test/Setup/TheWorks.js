...
contract('The Works', accounts => {
    ...
    it('Should add default contracts to storage', () => {
        ...
        return STOR.addDefaultContracts("0", "AC_MGR", '1', { from: account1 })
            ...
            .then(() => {
                console.log("Adding PIP to default contract list")
    ...
    it('Should add users to AC 1000001-1000006 in AC_Manager', () => {
        ...
        return AC_MGR.addUser('1000001', account4Hash, '1', { from: account1 })
            ...
            .then(() => {
                console.log("Account10 => 1000005 (PIPMINTER)")
                return AC_MGR.addUser('1000005', account10Hash, '10', { from: account1 })
            })

            .then(() => {
                console.log("Account10 => 1000006 (PIPMINTER)")
    ...
    it("Should retrieve asset12 @noChange", async () => {
        var Record = [];
    ...
    it('Should write nakedAsset14 in AC 1000006', async () => {
    ...
    it('Should claim nakedAsset14 in AC 1000002', async () => {
    ...
    it("Should retrieve asset14 @newStatus(70(exported))", async () => {
        var Record = [];
    ...
    it('Should import asset14 to AC(1000001)', async () => {
        return APP.importAsset(
            asset14,
            rgt14,
            '1000001',
    ...
    it("Should retrieve asset14 @newAC(1000001) && newStatus(0) && + 1 FMRcount", async () => {
        var Record = [];
    ...
    it("Should retrieve asset14 @newStatus(exported(70)) && + 1 N.O.T", async () => {
        var Record = [];
    ...
    it('Should import asset14 to AC(1000003)', async () => {
        return APP_NC.importAsset(
            asset14,
            '1000003',
            { from: account4 }
    ...
    it("Should retrieve asset14 @newAC(1000003) && newStatus(52)", async () => {
        var Record = [];
