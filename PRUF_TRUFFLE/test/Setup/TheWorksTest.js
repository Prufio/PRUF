...
*---------------------------------------------------------------------------*/
        ...
        contract('TheWorksTest', accounts => {
    ...
    it('Should mint ID_MGR(1) to account3', async () => {
    ...
    it('Should write asset13 in Node 12', async () => {
    ...
    it("Should retrieve UTIL_TKN balance for account4  (999780000000000000000)", async () => {
        var Record = [];
    ...
    it("Should retrieve UTIL_TKN balance for account4  (999760000000000000000)", async () => {
        var Record = [];
    ...
    it("Should retrieve UTIL_TKN balance for account4  (999740000000000000000)", async () => {
        var Record = [];
    ...
    it("Should retrieve UTIL_TKN balance for account2 (???)", async () => {
        var Record = [];
    ...
    it("Should retrieve UTIL_TKN balance for account4  (999710000000000000000)", async () => {
        var Record = [];
