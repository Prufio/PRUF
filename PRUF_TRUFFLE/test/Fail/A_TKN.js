  ...
  _\/\\\_______\/\\\_\/\\\_____\/\\\ ________________\/\\\ ____________      
   _\/\\\\\\\\\\\\\/__\/\\\\\\\\\\\/_____/\\\____/\\\_\/\\\\\\\\\\\ ____     
    ...
    it('Should fail because caller is not admin', async () => {
        ...
        console.log("//**************************************BEGIN A_TKN FAIL BATCH (16)**********************************************/")
        console.log("//**************************************BEGIN Admin_setStorageContract FAIL BATCH**********************************************/")
        return A_TKN.Admin_setStorageContract(
            STOR.address,
            { from: account2 }
        )
    })
    ...
    it('Should fail because caller is not admin', async () => {
        ...
        console.log("//**************************************END Admin_setStorageContract FAIL BATCH**********************************************/")
        console.log("//**************************************BEGIN Admin_resolveContractAddresses FAIL BATCH**********************************************/")
        return A_TKN.Admin_resolveContractAddresses(
            { from: account2 }
        )
    })
    ...
    it('Should fail because caller is not minter', async () => {
        ...
        console.log("//**************************************END Admin_resolveContractAddresses FAIL BATCH**********************************************/")
    ...
    it('Should fail because caller not trusted agent', async () => {
        ...
        console.log("//**************************************BEGIN trustedAgentTransferFrom FAIL BATCH**********************************************/")
    ...
    it('Should fail because caller not trusted agent', async () => {
        ...
        console.log("//**************************************END trustedAgentTransferFrom FAIL BATCH**********************************************/")
