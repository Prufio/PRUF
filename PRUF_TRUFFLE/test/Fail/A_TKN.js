...
contract("A_TKN", (accounts) => {
  ...
  it("Should export asset2", async () => {
    return APP2_NC.exportAssetTo(asset2, "1000003", { from: account4 });
  });
  ...
  it("Should put asset2 into status52", async () => {
    return APP2_NC.modifyStatus(asset2, "52", { from: account4 });
  });
  ...
  it("Should put asset2 into status51", async () => {
    return APP2_NC.modifyStatus(asset2, "51", { from: account4 });
  });
