...
contract("A_TKN", (accounts) => {
  ...
  it("Should fail because caller is not admin", async () => {
    ...
    return A_TKN.killTrustedAgent(STOR.address, { from: account2 });
  });

  //2
  it("Should fail because caller is not admin", async () => {
    console.log(
      "//**************************************END killTrustedAgent FAIL BATCH**********************************************/"
    );
    console.log(
  ...
  it("Should put asset2 into status52", async () => {
    return NP_NC.modifyStatus(asset2, "52", { from: account4 });
  });
  ...
  it("Should put asset2 into status51", async () => {
    return NP_NC.modifyStatus(asset2, "51", { from: account4 });
  });
  ...
  it("Should put asset2 into status52", async () => {
    return NP_NC.modifyStatus(asset1, "52", { from: account4 });
  });
  ...
  it("Should put asset2 into status51", async () => {
    return NP_NC.modifyStatus(asset1, "51", { from: account4 });
  });
