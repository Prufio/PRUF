...
contract("A_TKN", (accounts) => {
  ...
  it("Should fail because caller is not admin", async () => {
    ...
    console.log(
      "//**************************************BEGIN A_TKN FAIL BATCH (26)**********************************************/"
    );
    console.log(
      "//**************************************BEGIN adminKillTrustedAgent FAIL BATCH**********************************************/"
    );
    return A_TKN.adminKillTrustedAgent(STOR.address, { from: account2 });
  });

  //2
  it("Should fail because caller is not admin", async () => {
    console.log(
      "//**************************************END adminKillTrustedAgent FAIL BATCH**********************************************/"
    );
    console.log(
      "//**************************************BEGIN Admin_setStorageContract FAIL BATCH**********************************************/"
    );
    return A_TKN.Admin_setStorageContract(STOR.address, { from: account2 });
  });

  //3
  it("Should fail because storage addr = 0", async () => {
    return A_TKN.Admin_setStorageContract(account000, { from: account1 });
  });

  //4
  it("Should fail because caller is not admin", async () => {
    console.log(
      "//**************************************END Admin_setStorageContract FAIL BATCH**********************************************/"
    );
    console.log(
      "//**************************************BEGIN Admin_resolveContractAddresses FAIL BATCH**********************************************/"
    );
    return A_TKN.Admin_resolveContractAddresses({ from: account2 });
  });

  //5
  it("Should fail because caller is not minter", async () => {
    console.log(
      "//**************************************END Admin_resolveContractAddresses FAIL BATCH**********************************************/"
    );
    console.log(
      "//**************************************BEGIN mintAssetToken FAIL BATCH**********************************************/"
    );
    return A_TKN.mintAssetToken(account1, asset8, "Pruf.io", {
      from: account2,
    });
  });
  ...
  it("Should transfer AC13 to account4", async () => {
    return AC_TKN.safeTransferFrom(account10, account4, "1000004", {
      from: account10,
    });
  });
  ...
  it("Should import asset2", async () => {
    return APP_NC.importAsset(asset2, "1000003", { from: account4 });
  });

  it("Should put asset2 into status52", async () => {
    return NP_NC._modStatus(asset2, "52", { from: account4 });
  });
  ...
  //12
  it("Should fail because A_TKN is paused", async () => {
    return A_TKN.safeTransferFrom(account4, account5, asset2, {
      from: account4,
    });
  });
  ...
  it("Should put asset2 into status51", async () => {
    return NP_NC._modStatus(asset2, "51", { from: account4 });
  });
  ...
  it("Should pause A_TKN", async () => {
    ...
    console.log(
      "//**************************************BEGIN trustedAgentTransferFrom FAIL BATCH**********************************************/"
    );
    return A_TKN.pause({ from: account1 });
  });
  ...
  //17
  it("Should fail because A_TKN is paused", async () => {
    return A_TKN.trustedAgentTransferFrom(account4, account5, asset2, {
      from: account4,
    });
  });
  ...
  it("Should grant account4 with trusted agent role", async () => {
    return A_TKN.grantRole(trustedAgentRoleB32, account4, { from: account1 });
  });

  it("Should put asset2 into status52", async () => {
    return NP_NC._modStatus(asset1, "52", { from: account4 });
  });
  ...
  it("Should put asset2 into status51", async () => {
    return NP_NC._modStatus(asset1, "51", { from: account4 });
  });

  it("Should set account4 as cold wallet", async () => {
  ...
  it("Should remove account4 with trusted agent role", async () => {
    return A_TKN.revokeRole(trustedAgentRoleB32, account4, { from: account1 });
  });

  it("Should pause A_TKN", async () => {
    console.log(
      "//**************************************END trustedAgentTransferFrom FAIL BATCH**********************************************/"
    );
    console.log(
      "//**************************************BEGIN trustedAgentBurn FAIL BATCH**********************************************/"
    );
    return A_TKN.pause({ from: account1 });
  });
  ...
  it("Should unset account4 as cold wallet", async () => {
    return A_TKN.unSetColdWallet({ from: account4 });
  });

  it("Should pause A_TKN", async () => {
    console.log(
      "//**************************************END trustedAgentBurn FAIL BATCH**********************************************/"
    );
    console.log(
      "//**************************************BEGIN discard FAIL BATCH**********************************************/"
    );
    return A_TKN.pause({ from: account1 });
  });
  ...
  //24
  it("Should fail because A_TKN is paused", async () => {
    return A_TKN.discard(account4, account5, asset2, { from: account4 });
  });
  ...
  it("Should fail because caller is not pauser", async () => {
    ...
    return A_TKN.unpause({ from: account2 });
  });
