...
contract("A_TKN", (accounts) => {
  ...
  it("Should fail because caller is not admin", async () => {
    ...
    return A_TKN.setStorageContract(STOR.address, { from: account2 });
  });

  //3
  it("Should fail because storage addr = 0", async () => {
    return A_TKN.setStorageContract(account000, { from: account1 });
  });
  ...
  it("Should fail because caller is not admin", async () => {
    ...
    return A_TKN.resolveContractAddresses({ from: account2 });
  });
