...
contract("APP2_NC", (accounts) => {
  ...
  it("Should add users to Node 1000001-1000006 in AC_Manager", () => {
    ...
    return NODE_MGR.addUser("1000001", account4Hash, "1", { from: account1 })
      ...
      .then(() => {
        console.log("Account10 => 1000006");
        return NODE_MGR.addUser("1000006", account10Hash, "1", {
          from: account10,
        });
      })

      .then(() => {
        console.log("Account10 => 1000007");
        return NODE_MGR.addUser("1000007", account10Hash, "1", {
          from: account10,
        });
      })
  ...
  it("Should mint ID_MGR(2) to account5", async () => {
    return ID_MGR.mintID(account5, "4", asset4, { from: account1 });
  });

  it("Should mint asset1 in 1000003", async () => {
    return APP_NC.newRecord(asset1, rgt1, "1000003", "100", { from: account4 });
  });

  it("Should mint asset2 in 1000004", async () => {
    return APP_NC.newRecord(asset2, rgt2, "1000004", "100", { from: account5 });
  });

  it("Should mint asset4 in 1000003", async () => {
    return APP_NC.newRecord(asset4, rgt4, "1000003", "100", { from: account4 });
  });

  it("Should mint asset5 in 1000001 to APP", async () => {
    return APP.newRecord(asset5, rgt5, "1000001", "100", { from: account2 });
  });

  it("Should put asset2 in to discardable status", async () => {
    return APP2_NC.modifyStatus(asset2, "59", { from: account5 });
  });

  it("Should discard asset2 to put in unregistered status", async () => {
    return A_TKN.discard(asset2, { from: account5 });
  });
  ...
  it("Should transfer asset4 to put in unregistered status", async () => {
    return A_TKN.safeTransferFrom(account4, account1, asset4, {
      from: account4,
    });
  });
  ...
  it("Should mint asset7 in 1000003", async () => {
    return APP_NC.newRecord(asset7, rgt7, "1000003", "100", { from: account4 });
  });

  it("Should put asset6 in to stolen status", async () => {
    return APP2_NC.setLostOrStolen(asset6, "53", { from: account4 });
  });

  it("Should put asset7 in to lost status", async () => {
    return APP2_NC.setLostOrStolen(asset7, "54", { from: account4 });
  });

  it("Should mint asset8 in 1000007", async () => {
    return APP_NC.newRecord(asset8, rgt8, "1000007", "100", {
      from: account10,
    });
  });

  it("Should mint asset9 in 1000006", async () => {
    return APP_NC.newRecord(asset9, rgt8, "1000006", "100", {
      from: account10,
    });
  });

  it("Should transfer asset9 to account4", async () => {
    return A_TKN.safeTransferFrom(account10, account4, asset9, {
      from: account10,
    });
  });

  it("Should put asset4 in to transferable status", async () => {
    return APP2_NC.modifyStatus(asset9, "51", { from: account4 });
  });

  it("Should export asset9", async () => {
    return APP2_NC.exportAssetTo(asset9, "1000008", { from: account4 });
  });

  it("Should pause APP2_NC", async () => {
    console.log(
      "//**************************************END APP2_NC SETUP**********************************************/"
    );
    console.log(
      "//**************************************BEGIN APP2_NC FAIL BATCH (29)**********************************************/"
    );
    console.log(
      "//**************************************BEGIN _changeRGT FAIL BATCH**********************************************/"
    );
    return APP2_NC.pause({ from: account1 });
  });

  //1
  it("Should Fail because APP2_NC is paused", async () => {
    return APP2_NC.changeRgt(asset1, rgt2, { from: account5 });
  });

  it("Should unpause APP2_NC", async () => {
    return APP2_NC.unpause({ from: account1 });
  });
  ...
  it("Should fail because record is in stolen status", async () => {
    return APP2_NC.changeRgt(asset6, rgt5, { from: account4 });
  });

  //4
  it("Should fail because record is in lost status", async () => {
    return APP2_NC.changeRgt(asset7, rgt6, { from: account4 });
  });

  //5
  it("Should fail because record needsImport", async () => {
    return APP2_NC.changeRgt(asset9, rgt6, { from: account4 });
  });
  ...
  //6
  it("Should fail because APP2_NC is paused", async () => {
    return APP2_NC.exportAssetTo(asset1, "1000004", { from: account5 });
  });
  ...
  it("Should set asset1 stat to 52", async () => {
    return APP2_NC.modifyStatus(asset1, "52", { from: account4 });
  });

  //8
  it("Should fail because record != status51", async () => {
    return APP2_NC.exportAssetTo(asset1, "1000004", { from: account4 });
  });
  ...
  it("Should fail because you cannot export to new root", async () => {
    return APP2_NC.exportAssetTo(asset1, "1000007", { from: account4 });
  });

  //10
  it("Should fail because caller !NTH", async () => {
    return APP2_NC.exportAssetTo(asset8, "1000007", { from: account4 });
  });
  ...
  //11
  it("Should Fail because APP2_NC is paused", async () => {
    return APP2_NC.modifyStatus(asset1, "51", { from: account5 });
  });
  ...
  it("Should Fail because being placed in status > 100", async () => {
    return APP2_NC.modifyStatus(asset1, "101", { from: account4 });
  });

  //14
  it("Should Fail because being placed in status 7", async () => {
    return APP2_NC.modifyStatus(asset1, "7", { from: account4 });
  });

  //15
  it("Should Fail because being placed in reserved status 57", async () => {
    return APP2_NC.modifyStatus(asset1, "57", { from: account4 });
  });

  //16
  it("Should Fail because being placed in reserved status 58", async () => {
    return APP2_NC.modifyStatus(asset1, "58", { from: account4 });
  });

  //17
  it("Should Fail because being placed in exported status", async () => {
    return APP2_NC.modifyStatus(asset1, "70", { from: account4 });
  });

  //18
  it("Should Fail because being placed in status <50", async () => {
    return APP2_NC.modifyStatus(asset1, "1", { from: account4 });
  });
  ...
  //20
  it("Should Fail because APP2_NC is paused", async () => {
    return APP2_NC.setLostOrStolen(asset1, "53", { from: account5 });
  });
  ...
  it("Should fail because assetStatus is < 50", async () => {
    return APP2_NC.setLostOrStolen(asset1, "3", { from: account4 });
  });

  //23
  it("Should fail because asset needsImport", async () => {
    return APP2_NC.setLostOrStolen(asset9, "53", { from: account4 });
  });
  ...
  //24
  it("Should Fail because APP2_NC is paused", async () => {
    return APP2_NC.decrementCounter(asset1, "15", { from: account5 });
  });
  ...
  it("Should fail becasue asset needsImport", async () => {
    return APP2_NC.decrementCounter(asset9, "15", { from: account4 });
  });
  ...
  //27
  it("Should Fail because APP2_NC is paused", async () => {
    return APP2_NC.modifyMutableStorage(asset1, rgt1, rgt000, {
      from: account5,
    });
  });
  ...
  //29
  it("Should fail because asset needsImport", async () => {
    return APP2_NC.modifyMutableStorage(asset9, rgt1, rgt000, {
      from: account4,
    });
  });
