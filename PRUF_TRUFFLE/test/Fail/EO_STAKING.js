       ...
       _\/\\\ ____________\/\\\ _____\//\\\_\//\\\\\\\\\ _\/\\\ ____________ 
        ...
        contract("EO_STAKING", (accounts) => {
          ...
          it("Should fail because caller !have ASSET_TXFR_ROLE", async () => {
            console.log("//**************************************BEGIN EO_STAKING Fail Batch(14)**********************************************/");
            console.log("//**************************************BEGIN transferERC721Token Fail Batch**********************************************/");
            return EO_STAKING.transferERC721Token(account2, '1', STAKE_TKN.address, { from: account1 });
          });
          ...
          it("Should fail because caller !contractAdmin", async () => {
            ...
            return EO_STAKING.Admin_setTokenContracts(UTIL_TKN.address, STAKE_TKN.address, STAKE_VAULT.address, REWARDS_VAULT.address, { from: account2 });
          });

          //3
          it("Should fail because caller !contractAdmin", async () => {
            console.log("//**************************************END Admin_setTokenContracts Fail Batch**********************************************/");
            console.log("//**************************************BEGIN Admin_setStakeLevels Fail Batch**********************************************/");
          ...
          it("Should fail because interval !>=1", async () => {
            return EO_STAKING.Admin_setStakeLevels("1", "1000000000000000000000", "100000000000000000000000", "0", "50", {
              from: account1,
            });
          });
          ...
          it("Should fail because staking tier is inactive", async () => {
            console.log("//**************************************END Admin_setStakeLevels Fail Batch**********************************************/");
            console.log("//**************************************BEGIN stakeMyTokens Fail Batch**********************************************/");
          ...
          it("Should create staking tier 2", async () => {
            return EO_STAKING.Admin_setStakeLevels("2", "1000000000000000000000", "100000000000000000000000", "10", "50", {
              from: account1,
            });
          });
          ...
          //10
          it("Should fail because caller !stakeHolder", async () => {
            console.log("//**************************************END stakeMyTokens Fail Batch**********************************************/");
            console.log("//**************************************BEGIN breakStake Fail Batch**********************************************/");
          ...
          it("Should create staking tier 3", async () => {
            console.log("//**************************************END breakStake Fail Batch**********************************************/");
            console.log("//**************************************BEGIN newStake(internal) Fail Batch**********************************************/");
            return EO_STAKING.Admin_setStakeLevels("3", "1000000000000000000", "100000000000000000000000", "10", "50", {
              from: account1,
            });
          });
