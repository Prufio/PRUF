...
contract("APP", (accounts) => {
  ...
  it("Should export asset2 to account2", async () => {
    return NP.exportAsset(asset2, account2, { from: account2 });
  });
  ...
  it("Should export asset7", async () => {
    return NP.exportAsset(asset7, account2, { from: account2 });
  });
  ...
  it("Should authorize account9 in AC10", async () => {
    return AC_MGR.addUser("1000001", account9Hash, "9", { from: account1 });
  });
  ...
  it("Should unauthorize account9 in AC10", async () => {
    return AC_MGR.addUser("1000001", account9Hash, "0", { from: account1 });
  });
  ...
  it("Should add account2 to AC 1000001 @userType(11)", async () => {
    return AC_MGR.addUser("1000001", account2Hash, "11", { from: account1 });
  });
  ...
  it("Should fail because APP is paused", async () => {
    ...
    return APP.addIpfs2Note(asset3, rgt3, rgt2, rgt000, { from: account4 });
  });
  ...
  //22
  it("Should fail becasue user not auth for AC", async () => {
    return APP.addIpfs2Note(asset1, rgt1, rgt5, rgt000, { from: account6 });
  });

  //23
  it("Should fail becasue rgt does not match record data", async () => {
    return APP.addIpfs2Note(asset6, rgt5, rgt5, rgt000, { from: account2 });
  });
