...
contract("PURCHASE", (accounts) => {
  ...
  it("Should add users to Node 1000001-1000006 in AC_Manager", () => {
    ...
    return NODE_MGR.addUser("1000001", account4Hash, "1", { from: account1 })
      ...
      .then(() => {
        ...
        return NODE_MGR.addUser("1000003", account3Hash, "1", {
          from: account1,
        });
      })
  ...
  it("Should mint ID_MGR(3) to account2", async () => {
    console.log(
      "//**************************************************BEGIN PURCHASE TEST***************************************************//"
    );
    console.log(
      "//**************************************************BEGIN PURCHASE SETUP***************************************************//"
    );
    return ID_MGR.mintID(account2, "4", { from: account1 });
  });

  it("Should mint ID_MGR(4) to account3", async () => {
    return ID_MGR.mintID(account3, "5", { from: account1 });
  });
  ...
  it("Should mint 30000 tokens to account4", async () => {
    return UTIL_TKN.mint(account3, "30000000000000000000000", {
      from: account1,
    });
  });

  it("Should mint asset1 in Node 1000003", async () => {
    return APP_NC.newRecord(asset1, rgt1, "1000003", "5000", { from: account2 });
  });

  it("Should mint asset2 in Node 1000003", async () => {
    return APP_NC.newRecord(asset2, rgt2, "1000003", "5000", { from: account2 });
  });

  it("Should modify asset2 to status 52 (non-transferable)", async () => {
    return APP2_NC.modifyStatus(asset2, "52", { from: account2 });
  });

  it("Should mint asset3 in Node 12", async () => {
    return APP_NC.newRecord(asset3, rgt3, "1000003", "5000", { from: account2 });
  });

  it("Should export asset3", async () => {
    return APP2_NC.exportAssetTo(asset3, '1000004', { from: account2 });
  });
  ...
  it("Should mint asset5 in Node 1000003", async () => {
    return APP_NC.newRecord(asset5, rgt5, "1000003", "5000", { from: account2 });
  });

  it("Should put asset5 into escrow", async () => {
    return ECR_NC.setEscrow(asset5, account2Hash, "5000", "56", {
      from: account2,
    });
  });

  it("Should mint asset6 in Node 1000003", async () => {
    return APP_NC.newRecord(asset6, rgt6, "1000003", "5000", { from: account3 });
  });

  it("Should mint asset7 in Node 1000003", async () => {
    return APP_NC.newRecord(asset7, rgt7, "1000003", "5000", { from: account2 });
  });

  it("Should set price on asset7", async () => {
    return PURCHASE._setPrice(asset7, "1000", "2", "0", { from: account2 });
  });

  it("Should pause PURCHASE", async () => {
    return PURCHASE.pause({ from: account1 });
  });
  ...
  it("Should fail because contract is paused", async () => {
    ...
    console.log(
      "//**************************************************BEGIN PURCHASE FAIL BATCH (10)***************************************************//"
    );
    console.log(
      "//**************************************************BEGIN purchaseWithPRUF FAIL BATCH***************************************************//"
    );
    return PURCHASE.purchaseWithPRUF(asset2, { from: account2 });
  });

  it("Should unpause PURCHASE", async () => {
    return PURCHASE.unpause({ from: account1 });
  });
  ...
  it("Should fail because contract is paused", async () => {
    console.log(
      "//**************************************************END purchaseWithPRUF FAIL BATCH***************************************************//"
    );
    console.log(
      "//**************************************************BEGIN _setPrice FAIL BATCH***************************************************//"
    );
    return PURCHASE._setPrice(asset3, "1000", "2", "0", { from: account2 });
  });
  ...
  //4
  it("Should fail because asset is exported", async () => {
    return PURCHASE._setPrice(asset3, "1000", "2", "0", { from: account2 });
  });

  //5
  it("Should fail because asset is in escrow", async () => {
    return PURCHASE._setPrice(asset5, "1000", "2", "0", { from: account2 });
  });

  //6
  it("Should fail because currency !== 2", async () => {
    return PURCHASE._setPrice(asset1, "1000", "1", "0", { from: account2 });
  });
  ...
  it("Should fail because contract is paused", async () => {
    ...
    console.log(
      "//**************************************************BEGIN _clearPrice FAIL BATCH***************************************************//"
    );
    return PURCHASE._clearPrice(asset6, { from: account2 });
  });
  ...
  //9
  it("Should fail because asset is exported", async () => {
    return PURCHASE._clearPrice(asset3, { from: account2 });
  });

  //10
  it("Should fail because asset is in escrow", async () => {
    return PURCHASE._clearPrice(asset5, { from: account2 });
  });

  it("Should set SharesAddress", async () => {
    console.log(
      "//**************************************************END _clearPrice FAIL BATCH***************************************************//"
    );
    console.log(
      "//**************************************************END PURCHASE FAIL BATCH***************************************************//"
    );
    console.log(
      "//**************************************************END PURCHASE TEST***************************************************//"
    );
