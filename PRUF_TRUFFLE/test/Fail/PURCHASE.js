...
contract('PURCHASE', accounts => {
    ...
    it('Should mint ID_TKN(2) to account3', async () => {
        return ID_TKN.mintIDtoken(
            account3,
            '2',
            { from: account1}
    ...
    it('Should mint asset2 in Node 12', async () => {
        return APP_NC.newRecord(
            asset2,
            rgt2,
            '12',
    ...
    it('Should mint asset4 in Node 10', async () => {
    ...
    it('Should mint asset5 in Node 12', async () => {
        return APP_NC.newRecord(
            asset5,
            rgt5,
            '12',
    ...
    it('Should mint asset6 in Node 12', async () => {
        return APP_NC.newRecord(
            asset6,
            rgt6,
            '12',
    ...
    it('Should mint asset7 in Node 12', async () => {
        return APP_NC.newRecord(
            asset7,
            rgt7,
            '12',
    ...
    it('Should fail because asset is exported', async () => {
        console.log("//**************************************************END purchaseWithPRUF FAIL BATCH***************************************************//")
        console.log("//**************************************************BEGIN _setPrice FAIL BATCH***************************************************//")
        return PURCHASE._setPrice(
            asset3,
            "1000",
            "2",
    ...
    it('Should fail because caller does not hold token', async () => {
        ...
        console.log("//**************************************************BEGIN _clearPrice FAIL BATCH***************************************************//")
    ...
    it('Should write record in Node 10 @ IDX&RGT(1)', async () => {
        ...
        console.log("//**************************************************END _clearPrice FAIL BATCH***************************************************//")
        console.log("//**************************************************END PURCHASE FAIL BATCH***************************************************//")
