...
contract("BASIC", (accounts) => {
  ...
  it("Should write asset1 in AC 1000001", async () => {
  ...
  it("Should fail becasue caller != admin", async () => {
    ...
    return APP.Admin_resolveContractAddresses({ from: account2 });
  });

  //2
  it("Should fail becasue caller does not have ASSET_TXFR_ROLE", async () => {
    console.log(
      "//**************************************END Admin_resolveContractAddresses FAIL BATCH**********************************************/"
    );
    console.log(
      "//**************************************BEGIN transferAssetToken FAIL BATCH**********************************************/"
    );
    return APP.transferAssetToken(account1, asset1, { from: account2 });
  });
  ...
  it("Should fail becasue caller != admin", async () => {
    ...
    console.log(
      "//**************************************BEGIN Admin_transferACToken FAIL BATCH**********************************************/"
    );
    return APP.Admin_transferACToken(account1, asset1, { from: account2 });
  });

  //4
  it("Should fail because caller is not admin", async () => {
    console.log(
      "//**************************************END Admin_transferACToken FAIL BATCH**********************************************/"
    );
    console.log(
      "//**************************************BEGIN Admin_setStorageContract FAIL BATCH**********************************************/"
    );
    return APP.Admin_setStorageContract(STOR.address, { from: account2 });
  });

  //5
  it("Should fail because storageAddress != 0", async () => {
    return APP.Admin_setStorageContract(account000, { from: account1 });
  });
