...
contract("APP_NC", (accounts) => {
  ...
  it("Should export asset2 to 1000003", async () => {
    return APP2_NC.exportAssetTo(asset2, "1000003", { from: account2 });
  })
  ...
  it("Should export asset3 to 1000005", async () => {
    return APP2_NC.exportAssetTo(asset3, "1000005", { from: account2 });
  })
  ...
  it("Should export asset4 to 1000007", async () => {
    return APP2_NC.exportAssetTo(asset4, "1000007", { from: account2 });
  })
  ...
  it("Should export asset1 to Node 1000005", async () => {
    return APP2_NC.exportAssetTo(asset1, "1000005", { from: account1 });
  })
  ...
  it("Should modify status of asset1 to 51", async () => {
    return APP2_NC.modifyStatus(asset1, "51", { from: account1 });
  });
  ...
  it("Should export asset12 to account2", async () => {
    return APP2.exportAssetTo(asset12, "1000002", account2, rgt12, {
      from: account2,
    });
  });
  ...
  it("Should export asset13(status70)", async () => {
    return APP2.exportAssetTo(asset13, "1000002", account4, rgt13, {
      from: account4,
    });
  });
  ///
