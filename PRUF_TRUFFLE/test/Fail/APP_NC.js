...
contract("APP_NC", (accounts) => {
  ...
  it("Should finalize all ACs", () => {
    ...
    return NODE_MGR.modAssetClassSwitches("1000001", "1", "1", {
      ...
      .then(() => {
        return NODE_MGR.modAssetClassSwitches("1000007", "3", "1", {
          from: account1,
        });
      })

      .then(() => {
        return NODE_MGR.modAssetClassSwitches("1000008", "3", "1", {
          from: account1,
        });
      })

      .then(() => {
        return NODE_MGR.modAssetClassSwitches("1000009", "3", "1", {
          from: account1,
        });
      })
  });
  ...
  it("Should change status of asset3 to 51", async () => {
    return NP_NC._modStatus(asset3, "51", { from: account1 });
  });
  ...
  it("Should change status of asset4 to 51", async () => {
    return NP_NC._modStatus(asset4, "51", { from: account4 });
  });
  ...
  it("Should change status of asset5 to 51", async () => {
    return NP_NC._modStatus(asset5, "51", { from: account4 });
  });
  ...
  it("Should change status of asset6 to 51", async () => {
    return NP._modStatus(asset6, rgt6, "51", { from: account2 });
  });
  ...
  it("Should fail because APP_NC is paused", async () => {
    ...
    console.log(
      "//**************************************************BEGIN addIpfs2Note FAIL BATCH***************************************************//"
    );
    return APP_NC.addIpfs2Note(asset5, rgt5, rgt000, { from: account5 });
  });
