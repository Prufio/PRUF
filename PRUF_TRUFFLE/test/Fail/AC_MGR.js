...
contract('AC_MGR', accounts => {
    ...
    it('Should build variables', async () => {
        ...
        nodeMinterRoleB32 = await Helper.getStringHash(
            'NODE_MINTER_ROLE'
        )
    })
    ...
    it('Should fail because caller is not admin', async () => {
        ...
        console.log('//**************************************BEGIN adminSetACpricing FAIL BATCH**********************************************/')
        return AC_MGR.adminSetACpricing(
            '10',
            { from: account2 }
        )
    })
    ...
    //2
    it('Should fail because caller is not admin', async () => {
        console.log('//**************************************END adminSetACpricing FAIL BATCH**********************************************/')
        console.log('//**************************************BEGIN adminSetStorageProviders FAIL BATCH**********************************************/')
        return AC_MGR.adminSetStorageProviders(
            '6',
            '1',
            { from: account2 }
        )
    ...
    //3
    it('Should fail because caller is not admin', async () => {
        console.log('//**************************************END adminSetStorageProviders FAIL BATCH**********************************************/')
        console.log('//**************************************BEGIN adminSetManagementTypes FAIL BATCH**********************************************/')
        return AC_MGR.adminSetManagementTypes(
            '6',
            '1',
            { from: account2 }
        )
    ...
    //4
    it('Should fail because caller is not admin', async () => {
        console.log('//**************************************END adminSetManagementTypes FAIL BATCH**********************************************/')
        console.log('//**************************************BEGIN adminSetCustodyTypes FAIL BATCH**********************************************/')
        return AC_MGR.adminSetCustodyTypes(
            '6',
            '1',
            { from: account2 }
        )
    ...
    it('Should fail because bit pos !<0||>9', async () => {
        ...
        console.log('//**************************************BEGIN getSwitchAt FAIL BATCH**********************************************/')
        return AC_MGR.getSwitchAt(
            '1000001',
            '10',
            { from: account2 }
        )
    ...
    it('Should fail because AC not yet populated', async () => {
        ...
        console.log('//**************************************END getSwitchAt FAIL BATCH**********************************************/')
    ...
    it('Should retrieve show clean asset 12', async () => {
        ...
        return await AC_MGR.resolveAssetClass('TEST2', { from: account2 }, function (_err, _result) {
            if (_err) { }
            else {
                Record = Object.values(_result)
                console.log(Record)
