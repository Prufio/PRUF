        ...
        contract('WRAP', accounts => {
            ...
            it("Should Mint 2 cust and 2 non-cust AC tokens in AC_ROOT 1", async () => {
                ...
                return NODE_MGR.createAssetClass("10", 'CUSTODIAL_AC10', '1', '1', '0', "0", rgt000, account1, { from: account1 })
                    ...
                    .then(() => {
                        ...
                        return NODE_MGR.createAssetClass("16", 'CUSTODIAL_AC16', '2', '5', '1', "0", rgt000, account10, { from: account1 })
                    })
        
                    .then(() => {
                        console.log("Minting AC 17 -NC")
                        return NODE_MGR.createAssetClass("17", 'CUSTODIAL_AC17', '2', '5', '3', "0", rgt000, account1, { from: account1 })
                    })
        
                    .then(() => {
                        console.log("Minting AC 18 -NC")
                        return NODE_MGR.createAssetClass("18", 'CUSTODIAL_AC18', '2', '5', '4', "0", rgt000, account1, { from: account1 })
                    })
        
                    .then(() => {
                        console.log("Minting AC 19 -NC")
                        return NODE_MGR.createAssetClass("19", 'CUSTODIAL_AC19', '2', '5', '5', "0", rgt000, account1, { from: account1 })
                    })
            })
            ...
            it('Should authorize NP_NC in all relevant asset classes', async () => {
                ...
                return STOR.enableContractForAC('NP_NC', '12', '2', { from: account1 })
                    ...
                    .then(() => {
                        return STOR.enableContractForAC('NP_NC', '17', '2', { from: account1 })
                    })
            })
            ...
            it('Should authorize WRAP in all relevant asset classes', async () => {
            ...
            //8
            it('Should fail because AC managementType > 4', async () => {
                return WRAP.wrap721(
                    "2",
                    Foreign721.address,
                    rgt1,
