...
contract("APP", (accounts) => {
  ...
  it("Should put asset3 in to exportable status", async () => {
    return APP.modifyStatus(asset3, rgt3, "51", { from: account2 });
  });

  it("Should export asset3 to put in unregistered status", async () => {
    return APP.exportAssetTo(asset3, "1000003", account2, rgt3, {
      from: account2,
    });
  });
  ...
  it("Should put asset4 in to transferable status", async () => {
    return APP.modifyStatus(asset4, rgt4, "1", { from: account2 });
  });
  ...
  it("Should Fail because APP is paused", async () => {
    ...
    console.log(
      "//**************************************BEGIN APP FAIL BATCH (32)**********************************************/"
    );
    console.log(
      "//**************************************BEGIN modifyStatus FAIL BATCH**********************************************/"
    );
    return APP.modifyStatus(asset5, rgt5, "1", { from: account5 });
  });
  ...
  it("Should fail because account7 is usertype 9 trying to modStatus < 49", async () => {
    return APP.modifyStatus(asset1, rgt1, "1", { from: account7 });
  });
  ...
  it("Should fail because wrong rgt", async () => {
    return APP.modifyStatus(asset1, rgt2, "1", { from: account2 });
  });
  ...
  it("Should fail because APP is paused", async () => {
    ...
    return APP.setLostOrStolen(asset5, rgt5, "3", { from: account5 });
  });
  ...
  it("Should Fail because account5 != auth for AC1000001 assets", async () => {
    return APP.setLostOrStolen(asset1, rgt1, "3", { from: account5 });
  });
  ...
  //15
  it("Should fail because account7 is usertype 9 trying to modStatus < 49", async () => {
    return APP.setLostOrStolen(asset1, rgt1, "3", { from: account7 });
  });
  ...
  //16
  it("Should fail because wrong rgt", async () => {
    return APP.setLostOrStolen(asset1, rgt2, "3", { from: account2 });
  });
  ...
  it("Should fail because APP is paused", async () => {
    ...
    return APP.decrementCounter(asset5, rgt5, "15", { from: account5 });
  });
  ...
  it("Should Fail because account4 != auth for AC10 assets", async () => {
    return APP.decrementCounter(asset1, rgt1, "15", { from: account5 });
  });

  //20
  it("Should fail because asset4 is unregistered(transfered)", async () => {
    return APP.decrementCounter(asset4, rgtFFF, "15", { from: account2 });
  });

  //21
  it("Should fail because wrong rgt", async () => {
    return APP.decrementCounter(asset1, rgt2, "15", { from: account2 });
  });
  ...
  it("Should fail because APP is paused", async () => {
    ...
    return APP.modifyMutableStorage(asset5, rgt5, rgt5, rgt000, {
      from: account5,
    });
  });
  ...
  //24
  it("Should Fail because account5 != auth for AC10 assets", async () => {
    return APP.modifyMutableStorage(asset1, rgt1, rgt1, rgt000, {
      from: account5,
    });
  });
  ...
  //25
  it("Should fail because asset4 is unregistered(transfered)", async () => {
    return APP.modifyMutableStorage(asset4, rgtFFF, rgt4, rgt000, {
      from: account2,
    });
  });
  ...
  //26
  it("Should fail because wrong rgt", async () => {
    return APP.modifyMutableStorage(asset1, rgt2, rgt2, rgt000, {
      from: account2,
    });
  });
  ...
  it("Should fail because APP is paused", async () => {
    ...
    return APP.exportAssetTo(asset5, "1000003", account5, rgt5, {
      from: account5,
    });
  });
  ...
  it("Should set asset1 to newAssetStatus(51)", async () => {
    return APP.modifyStatus(asset1, rgt1, "51", { from: account2 });
  });

  //29
  it("Should Fail because account5 != auth for AC1000001 assets", async () => {
    return APP.exportAssetTo(asset1, "1000003", account4, rgt1, {
      from: account5,
    });
  });
  ...
  it("Should Fail because you cannot set asset to new root", async () => {
    return APP.exportAssetTo(asset1, "1000006", account4, rgt1, {
      from: account2,
    });
  });
  ...
  it("Should Fail because rgt !match", async () => {
    return APP.exportAssetTo(asset1, "1000003", account4, rgt5, {
      from: account2,
    });
  });
