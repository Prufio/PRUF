...
contract("APP_NC", (accounts) => {
  ...
  it("Should put asset2 in to discardable status", async () => {
    return APP_NC.modifyStatus(asset2, "59", { from: account5 });
  });
  ...
  it("Should put asset6 in to stolen status", async () => {
    return APP_NC.setLostOrStolen(asset6, "53", { from: account4 });
  });

  it("Should put asset7 in to lost status", async () => {
    return APP_NC.setLostOrStolen(asset7, "54", { from: account4 });
  });
  ...
  it("Should put asset4 in to transferable status", async () => {
    return APP_NC.modifyStatus(asset9, "51", { from: account4 });
  });

  it("Should export asset9", async () => {
    return APP_NC.exportAssetTo(asset9, "1000008", { from: account4 });
  });
  ...
  it("Should fail because record is in stolen status", async () => {
    return APP_NC.changeRgt(asset6, rgt5, { from: account4 });
  });

  //4
  it("Should fail because record is in lost status", async () => {
    return APP_NC.changeRgt(asset7, rgt6, { from: account4 });
  });

  //5
  it("Should fail because record needsImport", async () => {
    return APP_NC.changeRgt(asset9, rgt6, { from: account4 });
  });
  ...
  //23
  it("Should fail because asset needsImport", async () => {
    return APP_NC.setLostOrStolen(asset9, "53", { from: account4 });
  });
  ...
  it("Should fail becasue asset needsImport", async () => {
    return APP_NC.decrementCounter(asset9, "15", { from: account4 });
  });
  ...
  //29
  it("Should fail because asset needsImport", async () => {
    return APP_NC.modifyMutableStorage(asset9, rgt1, rgt000, {
      from: account4,
    });
  });
