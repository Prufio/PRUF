        ...
        contract('VERIFY', accounts => {
            ...
            it('Should add contract addresses', async () => {
                ...
                return STOR.authorizeContract("APP", APP.address, '0', '1', { from: account1 })
                    ...
                    .then(() => {
                        ...
                        return STOR.authorizeContract("PIP", PIP.address, '0', '2', { from: account1 })
                    })
                    ...
                    .then(() => {
                        ...
                        return STOR.authorizeContract("VERIFY", VERIFY.address, '0', '1', { from: account1 })
                    })
            })
            ...
            it('Should authorize APP in all relevant nodes', async () => {
                ...
                return STOR.enableContractForNode('APP', '10', '1', { from: account1 })
                    ...
                    .then(() => {
                        return STOR.enableContractForNode('APP', '11', '1', { from: account2 })
                    })
            })
            ...
            it('Should authorize APP_NC in all relevant nodes', async () => {
                ...
                return STOR.enableContractForNode('APP_NC', '12', '2', { from: account1 })
                    ...
                    .then(() => {
                        return STOR.enableContractForNode('APP_NC', '14', '2', { from: account2 })
                    })

                    .then(() => {
                        return STOR.enableContractForNode('APP_NC', '11', '2', { from: account2 })
                    })
        
                    .then(() => {
                        return STOR.enableContractForNode('APP_NC', '10', '2', { from: account1 })
                    })
                    ...
                    .then(() => {
                        return STOR.enableContractForNode('APP_NC', '15', '2', { from: account2 })
                    })
            })
            ...
            it('Should authorize MAL_APP in all relevant nodes', async () => {
                ...
                return STOR.enableContractForNode('MAL_APP', '10', '1', { from: account1 })
                    ...
                    .then(() => {
                        return STOR.enableContractForNode('MAL_APP', '11', '1', { from: account2 })
                    })
            })
            ...
            it('Should authorize ECR in all relevant nodes', async () => {
                ...
                return STOR.enableContractForNode('ECR', '10', '3', { from: account1 })
                    ...
                    .then(() => {
                        return STOR.enableContractForNode('ECR', '11', '3', { from: account2 })
                    })
            })
            ...
            it('Should authorize ECR2 in all relevant nodes', async () => {
                ...
                return STOR.enableContractForNode('ECR2', '10', '3', { from: account1 })
                    ...
                    .then(() => {
                        return STOR.enableContractForNode('ECR2', '11', '3', { from: account2 })
                    })
            })
            ...
            it('Should authorize ECR_NC in all relevant nodes', async () => {
                ...
                return STOR.enableContractForNode('ECR_NC', '12', '3', { from: account1 })
                    ...
                    .then(() => {
                        return STOR.enableContractForNode('ECR_NC', '14', '3', { from: account2 })
                    })
            ...
            it('Should authorize ECR_MGR in all relevant nodes', async () => {
                ...
                return STOR.enableContractForNode('ECR_MGR', '10', '3', { from: account1 })
                    ...
                    .then(() => {
                        return STOR.enableContractForNode('ECR_MGR', '11', '3', { from: account2 })
                    })
                    ...
                    .then(() => {
                        return STOR.enableContractForNode('ECR_MGR', '14', '3', { from: account2 })
                    })
            ...
            it('Should authorize NODE_TKN in all relevant nodes', async () => {
                ...
                return STOR.enableContractForNode('NODE_TKN', '10', '1', { from: account1 })
                    ...
                    .then(() => {
                        return STOR.enableContractForNode('NODE_TKN', '11', '1', { from: account2 })
                    })
                    ...
                    .then(() => {
                        return STOR.enableContractForNode('NODE_TKN', '14', '2', { from: account2 })
                    })
            })
            ...
            it('Should authorize A_TKN in all relevant nodes', async () => {
                ...
                return STOR.enableContractForNode('A_TKN', '10', '1', { from: account1 })
                    ...
                    .then(() => {
                        return STOR.enableContractForNode('A_TKN', '11', '1', { from: account2 })
                    })
                    ...
                    .then(() => {
                        return STOR.enableContractForNode('A_TKN', '14', '2', { from: account2 })
                    })
        
                    .then(() => {
                        return STOR.enableContractForNode('A_TKN', '15', '2', { from: account2 })
                    })
            ...
            it('Should authorize PIP in all relevant nodes', async () => {
                ...
                return STOR.enableContractForNode('PIP', '10', '1', { from: account1 })
                    ...
                    .then(() => {
                        return STOR.enableContractForNode('PIP', '11', '1', { from: account2 })
                    })
                    ...
                    .then(() => {
                        return STOR.enableContractForNode('PIP', '14', '2', { from: account2 })
                    })
        
                    .then(() => {
                        return STOR.enableContractForNode('PIP', '15', '2', { from: account2 })
                    })
            ...
            it('Should authorize NODE_MGR in all relevant nodes', async () => {
                ...
                return STOR.enableContractForNode('NODE_MGR', '10', '1', { from: account1 })
                    ...
                    .then(() => {
                        return STOR.enableContractForNode('NODE_MGR', '11', '1', { from: account2 })
                    })
                    ...
                    .then(() => {
                        return STOR.enableContractForNode('NODE_MGR', '14', '2', { from: account2 })
                    })
            })
            ...
            it('Should authorize RCLR in all relevant nodes', async () => {
                ...
                return STOR.enableContractForNode('RCLR', '10', '3', { from: account1 })
                    ...
                    .then(() => {
                        return STOR.enableContractForNode('RCLR', '11', '3', { from: account2 })
                    })
                    ...
                    .then(() => {
                        return STOR.enableContractForNode('RCLR', '14', '3', { from: account2 })
                    })
