...
*---------------------------------------------------------------------------*/
        ...
        contract('WRAP', accounts => {
            ...
            it('Should deploy Foreign721', async () => {
            ...
            it('Should build a few IDX and RGT hashes', async () => {
                ...
                recordCode2 = await Helper.getHashOfUint256AndAddress(
            ...
            it('Should add Storage in each contract', async () => {
                ...
                return APP.OO_setStorageContract(STOR.address, { from: account1 })
                    ...
                    .then(() => {
                        ...
                        return WRAP.OO_setStorageContract(STOR.address, { from: account1 })
                    })
            ...
            it('Should resolve contract addresses', async () => {
                ...
                return APP.OO_resolveContractAddresses({ from: account1 })
                    ...
                    .then(() => {
                        ...
                        return WRAP.OO_resolveContractAddresses({ from: account1 })
                    })
            ...
            it('Should authorize all payable contracts for transactions', async () => {
                ...
                return UTIL_TKN.grantRole(payableRoleB32, NODE_MGR.address, { from: account1 })
                    ...
                    .then(() => {
                        console.log("Authorizing WRAP")
                        return UTIL_TKN.grantRole(payableRoleB32, WRAP.address, { from: account1 })
                    })
            })
            ...
            it("Should Mint 2 cust and 2 non-cust Node tokens in AC_ROOT 1", async () => {
                ...
                return NODE_MGR.createNode("10", 'CUSTODIAL_AC10', '1', '1', '0', "0", rgt000, account1, { from: account1 })
                    ...
                    .then(() => {
                        ...
                        return NODE_MGR.createNode("13", 'CUSTODIAL_AC13', '1', '5', '0', "0", rgt000, account1, { from: account1 })
                    })
        
                    .then(() => {
                        console.log("Minting Node 16 -NC")
                        return NODE_MGR.createNode("16", 'CUSTODIAL_AC16', '2', '5', '1', "0", rgt000, account10, { from: account1 })
                    })
        
                    .then(() => {
                        console.log("Minting Node 17 -NC")
                        return NODE_MGR.createNode("17", 'CUSTODIAL_AC17', '2', '5', '3', "0", rgt000, account1, { from: account1 })
                    })
        
                    .then(() => {
                        console.log("Minting Node 18 -NC")
                        return NODE_MGR.createNode("18", 'CUSTODIAL_AC18', '2', '5', '4', "0", rgt000, account1, { from: account1 })
                    })
        
                    .then(() => {
                        console.log("Minting Node 19 -NC")
                        return NODE_MGR.createNode("19", 'CUSTODIAL_AC19', '2', '5', '5', "0", rgt000, account1, { from: account1 })
                    })
            })
            ...
            it("Should set costs in minted Node's", async () => {
                ...
                return NODE_MGR.setOperationCosts(
                    ...
                    .then(() => {
                        console.log("Setting base costs in Node 17")
                        return NODE_MGR.setOperationCosts(
                            "17",
                            "1",
                            "10000000000000000",
                    ...
                    .then(() => {
                        console.log("Setting base costs in Node 18")
                        return NODE_MGR.setOperationCosts(
                            "18",
                            "1",
                            "10000000000000000",
                    ...
                    .then(() => {
                        console.log("Setting base costs in Node 19")
                        return NODE_MGR.setOperationCosts(
                            "19",
                            "1",
                            "10000000000000000",
            ...
            it('Should approve WRAP to move external 721 0', async () => {
            ...
            it('Should approve WRAP to move external 721 2', async () => {
                return Foreign721.approve(
                    WRAP.address,
                    "2",
                    { from: account2 }
            ...
            it('Should fail because caller is not token holder', async () => {
                ...
                console.log("//**************************************BEGIN WRAP FAIL BATCH (11)**********************************************/")
            ...
            //3
            it('Should fail because Node extData != 0 || Foreign721.address', async () => {
                return WRAP.wrap721(
                    "0",
                    Foreign721.address,
                    rgt1,
            ...
            it('Should wrap external721 0', async () => {
                return WRAP.wrap721(
                    "0",
                    Foreign721.address,
                    rgt1,
            ...
            //7
            it('Should fail because asset token already exists', async () => {
        
                console.log("//**************************************END unWrap721 FAIL BATCH**********************************************/")
                console.log("//**************************************BEGIN createRecord(Internal) FAIL BATCH**********************************************/")
                return WRAP.wrap721(
                    "0",
                    Foreign721.address,
                    rgt1,
