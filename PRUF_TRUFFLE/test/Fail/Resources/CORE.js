...
contract("CORE", (accounts) => {
  ...
  it("Should authorize all minter contracts for minting A_TKN(s)", () => {
      ...
      .then(() => {
        ...
        return A_TKN.grantRole(minterRoleB32, MAL_APP.address, {
          from: account1,
        });
      })
  ...
  it("Should authorize APP_NC in all relevant nodes", () => {
    console.log("Authorizing APP_NC");
    return STOR.enableContractForNode("APP_NC", "1000002", "2", {
      from: account1,
    })
      ...
      .then(() => {
        return STOR.enableContractForNode("APP_NC", "1000005", "2", {
          from: account1,
        });
      })
      ...
      .then(() => {
        return STOR.enableContractForNode("APP_NC", "1000008", "2", {
          from: account10,
        });
      })
  ...
  it("Should fail because assetToken already exists", async () => {
    ...
    return APP_NC.newRecord(asset1, rgt13, "1000002", "100", { from: account2 });
  });
