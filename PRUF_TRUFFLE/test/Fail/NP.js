...
contract("NP", (accounts) => {
  ...
  it("Should authroize account2 in AC1000002", async () => {
      return AC_MGR.addUser("1000004", account5Hash, "1", { from: account10 });
  });
  ...
  it("Should authorize account7 in AC 10", async () => {
    return AC_MGR.addUser("1000001", account7Hash, "9", { from: account1 });
  });
  ...
  it("Should unauthorize account7 in AC 10", async () => {
    return AC_MGR.addUser("1000001", account7Hash, "0", { from: account1 });
  });
