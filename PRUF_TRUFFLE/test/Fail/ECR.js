...
contract("ECR", (accounts) => {
  ...
  it("Should make ECR unatuhorized", async () => {
    return STOR.enableContractForAC("ECR", "1000001", "0", { from: account1 })
    .then(() => {
      return STOR.enableContractForAC("ECR", "1000002", "0", {
        from: account1,
      });
    });
  });
  ...
  //         .then(() => {
  //             return STOR.enableContractForAC('ECR', '1000002', '0', { from: account1 })
  //         })
  // })
  ...
  it("Should make ECR unatuhorized", async () => {
    return STOR.enableContractForAC("ECR", "1000001", "0", {
      from: account1,
    }).then(() => {
      return STOR.enableContractForAC("ECR", "1000002", "0", {
        from: account1,
