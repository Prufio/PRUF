//
    ...
    it('Should add users to AC 10-14 in AC_Manager', async () => {
        ...
        it('Should change status of asset asset17 to 1 for transfer eligibility', async () => {
            return NP._modStatus(
                asset2,
                rgt1,
                '1',
        ...
        it('Should change status of asset15 to 51 for export eligibility', async () => {
            return NP._modStatus(
                asset15,
                rgt1,
                '51',
        ...
        it('Should change status of asset22 to 59 for discard eligibility', async () => {
            return NP_NC._modStatus(
                asset22,
                '59',
                { from: account6 }
        ...
        it('Should change status of asset18 to 1 for transfer eligibility', async () => {
            return NP._modStatus(
                asset18,
                rgt1,
                '1',
        ...
        it('Should put asset13 into an escrow', async () => {
            return ECR.setEscrow(
                asset13,
                rgt1,
                '1',
        ...
        it('Should put asset21 into an escrow', async () => {
            return ECR_NC.setEscrow(
                asset21,
                account6Hash,
                '1',
        ...
        it('Should transfer asset18 to unclaimed', async () => { // Transferred, not claimed, used in status !== status 5 checks 
            return APP.$transferAsset(
                asset18,
                rgt1,
                rgt000,
        ...
        it('Should export asset15 to account2 in AC10', async () => {
            return NP.exportAsset(
                asset15,
                NP.address,
                { from: account3 }
        ...
        it('Should discard asset22', async () => {
            return A_TKN.discard(
                asset22,
                { from: account6 }
            )
        ...
        //SHOULD PASS
        it('Should remove asset21 from escrow', async () => {
