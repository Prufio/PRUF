...
contract('THE WORKS NC', accounts => {
    ...
    // it("Should retrieve UTIL_TKN balance for account10  (10000000000000000)", async () => {
    //     var Record = [];

    //     return await UTIL_TKN.balanceOf(account10, { from: account10 }, function (_err, _result) {
    //         if (_err) { }
    //         else {
    //             Record = Object.values(_result)
    //             console.log(Record)
