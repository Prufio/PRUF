...
*---------------------------------------------------------------------------*/
  ...
  it("Should mint AC20", async () => {
    return AC_TKN.mintACToken(account2, "20", "Pruf.io", { from: account1 });
  });

  it("Should retrieve 170", async () => {
    var Record = "";

    return await AC_TKN.tokenExists(
      "20",
      { from: account2 },
  ...
  it("Should remint AC20 to account3", async () => {
    return AC_TKN.teleportACToken(account3, "20", "Pruf.io", { from: account1 });
  });
  ...
  it("Should transfer AC20 from Account3 to Account2", async () => {
    return AC_TKN.transferFrom(account3, account2, "20", { from: account3 });
  });
  ...
  it("Should transfer AC20 from account2 to account3", async () => {
    return AC_TKN.safeTransferFrom(account2, account3, "20", {
      from: account2,
    });
  });
  ...
  it("Should pause", async () => {
    return AC_TKN.pause({ from: account1 });
  });

  it("Should unpause", async () => {
    return AC_TKN.unpause({ from: account1 });
  });
