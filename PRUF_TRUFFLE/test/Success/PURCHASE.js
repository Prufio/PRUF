...
contract('PURCHASE', accounts => {
    ...
    it('Should resolve contract addresses', async () => {
        ...
        .then(() => {
            ...
            return PURCHASE.OO_resolveContractAddresses({ from: account1 })
        })
    })
    ...
    it('Should authorize all minter contracts for minting A_TKN(s)', async () => {
        ...
        return A_TKN.grantRole(minterRoleB32, NP.address, { from: account1 })
            ...
            .then(() => {
                console.log("Authorizing PURCHASE as trustedAgent")
    ...
    it('Should authorize NODE_MGR for minting NODE_TKN(s)', async () => {
        console.log("Authorizing NODE_MGR")
        return NODE_TKN.grantRole(minterRoleB32, NODE_MGR.address, { from: account1 })
    })


    it('Should authorize NP for transfering A_TKN(s)', async () => {
        console.log("Authorizing NP")
        return APP.grantRole(assetTransferRoleB32, NP.address, { from: account1 })
    })


    it('Should authorize A_TKN for discarding A_TKN(s)', async () => {
        console.log("Authorizing A_TKN")
        return RCLR.grantRole(discardRoleB32, A_TKN.address, { from: account1 })
    })


    it('Should authorize PURCHASE as a trustedAgent in UTIL_TKN', async () => {
        console.log("Authorizing PURCHASE")
    ...
    it("Should Mint 2 cust and 2 non-cust AC tokens in AC_ROOT 1", async () => {
        ...
        return NODE_MGR.createAssetClass("10", 'CUSTODIAL_AC10', '1', '1', '0', "0", rgt000, account1, { from: account1 })
            ...
            .then(() => {
                ...
                return NODE_MGR.createAssetClass("16", 'CUSTODIAL_AC16', '1', '2', '0', "0", rgt000, account10, { from: account1 })
            })
    })
    ...
    it('Should set SharesAddress', async () => {
        ...
        console.log("//**************************************************BEGIN PURCHASE TEST***************************************************//")
        console.log("//**************************************************BEGIN PURCHASE SETUP***************************************************//")
    ...
    it('Should mint 10000 tokens to account2', async () => {
    ...
    it("Should retrieve balanceOf(10000) Pruf tokens @account2", async () => {
        var Balance = [];

        return await UTIL_TKN.balanceOf(account2, { from: account3 }, function (_err, _result) {
            if (_err) { }
            else {
    ...
    it('Should mint 1000 tokens to account3', async () => {
        return UTIL_TKN.mint(
            account3,
    ...
    it("Should retrieve balanceOf(1000) Pruf tokens @account3", async () => {
        var Balance = [];
    ...
    it('Should mint asset1 in AC 12', async () => {
    ...
    it("Should retrieve balanceOf(9999.8) Pruf tokens @account2", async () => {
        var Balance = [];
    ...
    it("Should retrieve priceData(asset1) CLEAN", async () => {
        var priceInfo = [];

        return await STOR.getPriceData(asset1, { from: account1 }, function (_err, _result) {
            if (_err) { }
            else {
                priceInfo = Object.values(_result)
                console.log(priceInfo)
            }
        })
    })

    it('Should set price (1000) on asset1', async () => {

        console.log("//**************************************************BEGIN PURCHASE SUCCESS BATCH***************************************************//")
    ...
    it("Should retrieve priceData(asset1) Price(1000) Currency(2)", async () => {
        var priceInfo = [];
    ...
    it('Should clear price on asset1', async () => {
        return PURCHASE._clearPrice(
            asset1,
            { from: account2 }
        )
    })
    ...
    it('Should set price (500) on asset1', async () => {
        return PURCHASE._setPrice(
            asset1,
    ...
    it("Should retrieve priceData(asset1) Price(500) Currency(2)", async () => {
        var priceInfo = [];
    ...
    it('Should purchase asset1 for (500)', async () => {
    ...
    it("Should retrieve balanceOf(500) Pruf tokens @account3", async () => {
        var Balance = [];
    ...
    it('Should write record in AC 10 @ IDX&RGT(1)', async () => {
        console.log("//**************************************************END PURCHASE SUCCESS BATCH***************************************************//")
        console.log("//**************************************************END PURCHASE TEST***************************************************//")
