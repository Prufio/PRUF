...
contract("APP_NC", (accounts) => {
  ...
  it("Should mint asset1 in AC 1000003", async () => {
  ...
  it("Should mint asset2 in AC 1000003", async () => {
  ...
  it("Should change status of asset1 to 51", async () => {
    return NP_NC._modStatus(asset1, "51", { from: account1 });
  });

  it("Should change status of asset2 to 51", async () => {
    return NP_NC._modStatus(asset2, "51", { from: account1 });
  });

  it("Should export asset2", async () => {
    return NP_NC._exportNC(asset2, { from: account1 });
  });
  ...
  it("Should put ipfs2 onto asset1", async () => {
    return APP_NC.addIpfs2Note(asset1, rgt1, rgt000, { from: account1 });
  });
