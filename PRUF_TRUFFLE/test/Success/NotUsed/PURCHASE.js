...
contract("PURCHASE", (accounts) => {
  ...
  it("Should mint ID_MGR(1) to account2", async () => {
    return ID_MGR.mintID(account2, "4", { from: account1 });
  });

  it("Should mint 10000 tokens to account2", async () => {
    return UTIL_TKN.mint(account2, "10000000000000000000000", {
      from: account1,
    });
  });
  ...
  it("Should mint 1000 tokens to account3", async () => {
    return UTIL_TKN.mint(account3, "1000000000000000000000", {
      from: account1,
    });
  });
  ...
  it("Should set price (1000) on asset1", async () => {
    console.log(
      "//**************************************************BEGIN PURCHASE SUCCESS BATCH***************************************************//"
    );
    return PURCHASE._setPrice(asset1, "1000000000000000000000", "2", "0", {
      from: account2,
    });
  });
  ...
  it("Should clear price on asset1", async () => {
    return PURCHASE._clearPrice(asset1, { from: account2 });
  });
  ...
  it("Should set price (500) on asset1", async () => {
    return PURCHASE._setPrice(asset1, "500000000000000000000", "2", "0", {
      from: account2,
    });
  });
  ...
  it("Should purchase asset1 for (500)", async () => {
    return PURCHASE.purchaseWithPRUF(asset1, { from: account3 });
  });
