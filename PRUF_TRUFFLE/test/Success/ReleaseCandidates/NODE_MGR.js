...
contract("TheWorks", (accounts) => {
  ...
  it("Should set Node pricing to 10", async () => {
    return NODE_MGR.setNodePricing("10000000000000000000", { from: account1 });
  });

  it("Should retrieve currentNodePricingInfo", async () => {
    var Record = [];

    return await NODE_MGR.currentNodePricingInfo(
      { from: account1 },
      function (_err, _result) {
        if (_err) {
        } else {
  ...
  it("Should increase share of Node 1000001", async () => {
    return NODE_MGR.increaseShare("1000001", "9900", { from: account1 });
  });

  it("Should retrieve AC_discount (1000001) discount(9900)", async () => {
    var Record = [];

    return await NODE_MGR.getNodeDiscount(
      "1000001",
      { from: account1 },
      function (_err, _result) {
        if (_err) {
  ...
  it("Should enable storageProvider 6", async () => {
    return NODE_MGR.setStorageProviders("6", "1", { from: account1 });
  });
  ...
  it("Should enable management type 6", async () => {
    return NODE_MGR.setCustodyTypes("6", "1", { from: account1 });
  });
  ...
  it("Should return Node 1000002", async () => {
    var Record = [];
  ...
  it("Should mod Node 1 discount", async () => {
  ...
  it("Should retrieve switch (5) (0) @Node 1000003", async () => {
    var Record = [];

    return await NODE_MGR.getSwitchAt(
      "1000003",
      "5",
      { from: account1 },
      function (_err, _result) {
  ...
  it("Should modify switch 5 to 1", async () => {
    return NODE_MGR.modifyNodeSwitches("1000003", "5", "1", {
      from: account1,
    });
  });

  it("Should retrieve switch (5) (1) @Node 1000003", async () => {
    var Record = [];
  ...
  it("Should update name of Node 20 to ACTEST", async () => {
    return NODE_MGR.updateNodeName("20", "ACTEST", { from: account1 });
  });

  it("Should return Node 20", async () => {
    var Record = [];
  ...
  it("Should return 1", async () => {
    ...
    return await NODE_MGR.getUserType(
      account4Hash,
      "1000001",
      { from: account1 },
      function (_err, _result) {
  ...
  it("Should return 170", async () => {
    ...
    return await NODE_MGR.isSameRootNode(
      "1000002",
      "1000001",
      { from: account1 },
      function (_err, _result) {
  ...
  it("Should return ACTEST", async () => {
    ...
    return await NODE_MGR.getNodeName(
      "20",
      { from: account1 },
      function (_err, _result) {
        if (_err) {
  ...
  it("Should set SharesAddress", async () => {
    ...
    it("Should modify Mutable note @asset12 to (asset12)", async () => {
      return APP.modifyMutableStorage(asset12, rgt12, asset12, rgt000, { from: account2 });
    });
    ...
    it("Should modify Mutable @asset12 to RGT(12)", async () => {
      return APP_NC.modifyMutableStorage(asset12, rgt12, rgt000, { from: account2 });
    });
    ...
    it("Should modify Mutable note @asset13 to (asset13)", async () => {
      return APP_NC.modifyMutableStorage(asset13, asset13, rgt000, { from: account4 });
    });
    ...
    it("Should modify Mutable @asset13 to RGT(12)", async () => {
      return APP.modifyMutableStorage(asset13, rgtFFF, rgt13, rgt000, { from: account4 });
    });
    ...
    it("Should export asset13(status70)", async () => {
      return APP.exportAssetTo(asset13, "1000003", account4, rgt13, { from: account4 });
    });
    ///
