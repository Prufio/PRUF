...
contract("TheWorks", (accounts) => {
  ...
  it("Should build variables", async () => {
    ...
    asset3 = await Helper.getIdxHash(asset3raw, '1000003');

    asset4 = await Helper.getIdxHash(asset4raw, '1000003');
  ...
  it("Should mint ID to account4", async () => {
    ...
    it('Should put asset2 into status 59', async () => {
    ...
    it('Should set node switch 2 to 0 in Node 1000003', async () => {
      return NODE_STOR.modifyNodeSwitches("1000003", "2", "0", {
        from: account1,
      });
    })
