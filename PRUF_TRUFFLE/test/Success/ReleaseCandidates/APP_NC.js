...
contract("APP_NC", (accounts) => {
  ...
  it("Should mint asset1 in Node 1000003", async () => {
    return APP_NC.newRecord(asset1, rgt1, "1000003", "5000", { from: account1 });
  });

  it("Should retrieve balance of (1) @ account1", async () => {
    var Record = "";

    return await A_TKN.balanceOf(
      account1,
      { from: account1 },
  ...
  it("Should mint asset2 in Node 1000003", async () => {
    return APP_NC.newRecordWithDescription(asset2, rgt2, "1000003", "5000", rgt1, rgt1, {
      from: account1,
    });
  });

  it("Should retrieve balance of (2) @ account1", async () => {
    var Record = "";
  ...
  it("Should mint asset3 in Node 1000003", async () => {
    return APP_NC.newRecordWithDescription(asset3, rgt3, "1000003", "5000", rgt1, rgt1, {
      from: account1,
    });
  });

  it("Should retrieve balance of (3) @ account1", async () => {
    var Record = "";
  ...
  it("Should change status of asset2 to 51", async () => {
    return APP_NC.modifyStatus(asset2, "51", { from: account1 });
  });
