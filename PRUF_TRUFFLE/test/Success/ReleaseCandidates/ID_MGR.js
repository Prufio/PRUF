...
contract("ID_MGR", (accounts) => {
  ...
  it("Should mint ID to account2", async () => {
    return ID_MGR.mintID(account2, "5", asset5, { from: account1 });
  });

  it("Should burn PRUF_ID 1 from account2", async () => {
    return ID_MGR.burnID(account2, { from: account1 });
  });
  ...
  it("Should set trust level to 1 on PRUF_ID 1", async () => {
    return ID_MGR.setTrustLevel(account2, "1", { from: account1 });
  });

  it("Should retrieve IDData of account2", async () => {
    var Record = "";

    return await ID_MGR.IdDataByAddress(
      account2,
      { from: account2 },
  ...
  it("Should retrieve IDData of IdHash asset5", async () => {
    var Record = "";

    return await ID_MGR.IdDataByIdHash(
      asset5,
      { from: account2 },
      function (_err, _result) {
        if (_err) {
  ...
  it("Should retrieve trustLevel of account2", async () => {
    var Record = "";

    return await ID_MGR.trustLevel(
      account2,
      { from: account2 },
      function (_err, _result) {
        if (_err) {
