...
contract("ECR", (accounts) => {
  ...
  it("Should write ID to account2", async () => {
    return ID_MGR.mintID(account2, "5", asset4, { from: account1 });
  });

  it("Should write asset1 in Node 1000002", async () => {
    return APP.newRecord(asset1, rgt1, "1000002", "100", { from: account2 });
  });
  ...
  it("Should retrieve escrow info of asset1", async () => {
    ...
    return await ECR_MGR.retrieveEscrowData(
      asset1,
      { from: account4 },
...
//   it("Should set asset1 into escrow", async () => {
//     return ECR.setEscrowExtendedData(asset1, account2Hash, "180", "6", {
//       from: account2,
//     });
//   });
...
//     return await ECR_MGR.retrieveEscrowDataLight(
//       asset1,
//       { from: account4 },
//       function (_err, _result) {
//         if (_err) {
...
//     return await ECR_MGR.retrieveEscrowDataHeavy(
//       asset1,
//       { from: account4 },
//       function (_err, _result) {
//         if (_err) {
