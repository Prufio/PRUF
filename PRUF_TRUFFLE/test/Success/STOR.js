...
contract("STOR", (accounts) => {
  ...
  it("Should enable AC10 for default contracts", async () => {
    return STOR.enableDefaultContractsForAC("1000001", { from: account1 });
  });

  it("Should enable ECR2 for AC10", async () => {
    return STOR.enableContractForAC("ECR2", "1000001", "5", { from: account1 });
  });
  ...
  it("Should decrement asset1 by 15", async () => {
    return APP2_NC.decrementCounter(asset1, "15", { from: account4 });
  });
  ...
  it("Should set asset1 to stolen", async () => {
    return APP2_NC.setLostOrStolen(asset1, "53", { from: account4 });
  });
  ...
  it("Should set mutable on asset1 to rgt1 and rgt2", async () => {
    return APP2_NC.modifyMutableStorage(asset1, rgt1, rgt2, { from: account4 });
  });
