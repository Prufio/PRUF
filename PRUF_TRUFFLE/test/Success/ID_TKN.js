...
contract("TheWorks", (accounts) => {
  ...
  it("Should mint ID(1) to account2", async () => {
    return ID_MGR.mintID(account2, "5", { from: account1 });
  });

  it("Should retrieve balanceOf 1 ID_MGR", async () => {
    var Record = "";

    return await ID_MGR.balanceOf(
      account2,
      { from: account2 },
  ...
  it("Should burn PRUF_ID 1 from account2", async () => {
    return ID_MGR.burnID("5", { from: account1 });
  });

  it("Should retrieve balanceOf 0 ID_MGR", async () => {
    var Record = "";
  ...
  it("Should reMint PRUF_ID 1 to account1", async () => {
    return ID_MGR.remintID(account1, "5", { from: account1 });
  });
  ...
  it("Should setURI on PRUF_ID 1", async () => {
    return ID_MGR.setURI("5", "Pruf.io", { from: account1 });
  });

  it("Should set IDURI to PRUF_ID 1", async () => {
    return ID_MGR.setIdURI("5", rgt1, { from: account1 });
  });

  it("Should set username(user) to ID(1)", async () => {
    return ID_MGR.setUserName("5", "user", { from: account1 });
  });

  it("Should set trust level to 1 on PRUF_ID 1", async () => {
    return ID_MGR.setTrustLevel("5", "1", { from: account1 });
  });
