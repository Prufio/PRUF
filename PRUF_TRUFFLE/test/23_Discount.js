...
contract('THE WORKS CUSTODIAL', accounts => {
...
it("Should Mint 5 cust AC tokens in AC_ROOT 1", async () => {
    ...
    return AC_MGR.createAssetClass(account1, "Custodial_AC1", "10", "1", "1", { from: account1 })
        ...
        .then(() => {
            ...
            return AC_MGR.createAssetClass(account1, "Custodial_AC1", "12", "1", "1", { from: account1 })
        })
        
        .then(() => {
            console.log("Minting AC 13")
            return AC_MGR.createAssetClass(account1, "Custodial_AC2", "13", "2", "1", { from: account1 })
        })

        .then(() => {
            console.log("Minting AC 14")
            return AC_MGR.createAssetClass(account10, "Custodial_AC5", "14", "2", "1", { from: account1 })
        })
})
