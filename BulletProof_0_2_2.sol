...
contract BulletProof is Storage {
     ...
     */
    function newRecord(address sender, bytes32 idx, bytes32 regstrnt, uint8 stat, uint8 _assetClass, string memory desc) internal { //public
        require(
        ...
        database[idx].assetClass = _assetClass;
